...
const areas: Area[] = [
    { id: 1, topPercent: 15, leftPercent: 35, widthPercent: 20, heightPercent: 10 }
];
...
export default function MapPage() {
    ...
    const handleModalClick = (e: React.MouseEvent) => {
        ...
        if(selectedModal === "success") router.push("/quiz?quizNum=5")
    };
                ...
                {showDescription && (
                    <div className="fixed inset-0 z-40 bg-black/60 flex items-center justify-center p-4">
                        <div className="relative w-full max-w-[480px] flex flex-col items-center gap-4">
                            <img
                                src="/map_5/map_5_description.png"
                                alt="지도 이용 안내"
                                className="w-[90%] max-w-[700px] h-auto drop-shadow-xl"
                            />
                            <img
                                src="/map_5/map_5_pic.jpg"
                                alt="지도 안내 이미지"
